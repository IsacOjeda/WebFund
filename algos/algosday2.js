...
function indexOf(items, searchItem) {
	...
	/*created a loop that will run through indexOf
	and if the search item is equal to items[i] then it will return i
 ...
 */
/*
created an if statement that checks if nthtolast is greater than 0 and also checks
if nthtolast is less than the length of items.
if true idx turns into the length of items minus nthtolast which will return items[idx] 
if requirements not met null will return.
